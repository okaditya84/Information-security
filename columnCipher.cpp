...
string encryptSimpleColumnTransposition(const string &plainText, const string &key)
{
    ...
    // sorting is done because we need to arrange the columns in the order of the key
    string sortedKey = key;
    sort(sortedKey.begin(), sortedKey.end());
    // permutation is required because we need to arrange the columns in the order of the key
